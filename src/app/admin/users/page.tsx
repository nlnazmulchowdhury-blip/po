            ...
            <div className="flex h-16 items-center px-4 md:px-8 justify-between w-full">
              <div className="flex items-center gap-4">
                ...
                <div className="hidden lg:block">
                   <h1 className="text-xl font-bold text-white uppercase italic tracking-widest">User<span className="text-primary">Registry</span></h1>
                </div>
              </div>
              <div className="flex items-center gap-4">
                <AdminUserMenu />
            ...
            <div className="w-full max-w-none space-y-6 md:space-y-8">
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 w-full">
                <div className="space-y-1">
                  <h1 className="text-2xl md:text-3xl font-headline font-bold tracking-tight text-white uppercase italic">User <span className="text-primary">Registry</span></h1>
                  <p className="text-muted-foreground text-xs md:text-sm font-medium">Monitor your community and manage permissions.</p>
                </div>
              </div>
                        ...
                        {loading ? (
                          <tr>
                            <td colSpan={5} className="p-0">
                              <LoadingScreen message="ইউজার ডাটা লোড হচ্ছে..." fullScreen={false} />
                            </td>
                          </tr>
